...
│
├── app.vue                    # Root component (global styles, page shell)
...
- **PWA**: service worker and manifest generated by @vite-pwa/nuxt
...
- **Service Worker**: generated by @vite-pwa/nuxt (Workbox precache, autoUpdate)
